...
CMIP/notebooks/CMIP_distribution_and_AE_tas_exp4_res_only.ipynb
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--notebook",
        default="notebooks/trainings/variable/CMIP_distribution_and_AE_tas_exp4_res_only.ipynb",
    ...
    parser.add_argument(
        "--executed-notebook",
        default="notebooks/CMIP_distribution_and_AE_tas_exp4_res_only.executed.ipynb",
...
def main() -> int:
    ...
    print("[DONE] Exp 4 batch run completed.")
    return 0
