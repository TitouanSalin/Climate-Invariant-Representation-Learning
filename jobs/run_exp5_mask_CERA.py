#!/usr/bin/env python3
"""Run CMIP_mask_exp5_CERA notebook in batch mode and export artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Execute CMIP_mask_exp5_CERA notebook and export artifacts")
    parser.add_argument("--project-dir", default="/glade/u/home/tsalin/CMIP", help="Project directory containing notebooks/")
    parser.add_argument(
        "--notebook",
        default="notebooks/trainings/mask/CMIP_mask_exp5_CERA.ipynb",
    ...
    parser.add_argument(
        "--executed-notebook",
        default="notebooks/CMIP_mask_exp5_CERA.executed.ipynb",
...
def main() -> int:
    ...
    print("[DONE] CMIP_mask_exp5_CERA batch run completed.")
    return 0
