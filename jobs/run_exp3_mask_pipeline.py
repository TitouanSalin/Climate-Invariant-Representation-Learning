...
CMIP/notebooks/trainings/mask/CMIP_mask_exp3.ipynb
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--notebook",
        default="notebooks/trainings/mask/CMIP_mask_exp3.ipynb",
    ...
    parser.add_argument(
        "--executed-notebook",
        default="notebooks/CMIP_mask_exp3.executed.ipynb",
...
def main() -> int:
    ...
    print("[DONE] Exp 3 mask batch run completed.")
    return 0
