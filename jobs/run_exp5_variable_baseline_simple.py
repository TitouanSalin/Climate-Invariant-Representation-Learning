#!/usr/bin/env python3
"""Run CMIP_variable_exp5_baseline_simple notebook in batch mode and export artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Execute CMIP_variable_exp5_baseline_simple notebook and export artifacts")
    parser.add_argument("--project-dir", default="/glade/u/home/tsalin/CMIP", help="Project directory containing notebooks/")
    parser.add_argument(
        "--notebook",
        default="notebooks/trainings/variable/CMIP_variable_exp5_baseline_simple.ipynb",
    ...
    parser.add_argument(
        "--executed-notebook",
        default="notebooks/CMIP_variable_exp5_baseline_simple.executed.ipynb",
...
def main() -> int:
    ...
    print("[DONE] CMIP_variable_exp5_baseline_simple batch run completed.")
    return 0
