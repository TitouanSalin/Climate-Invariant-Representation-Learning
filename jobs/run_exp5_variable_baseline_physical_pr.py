#!/usr/bin/env python3
"""Run CMIP_variable_exp5_baseline_physical_pr notebook in batch mode and export artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Execute CMIP_variable_exp5_baseline_physical_pr notebook and export artifacts")
    parser.add_argument("--project-dir", default="/glade/u/home/tsalin/CMIP", help="Project directory containing notebooks/")
    parser.add_argument(
        "--notebook",
        default="notebooks/trainings/variable/CMIP_variable_exp5_baseline_physical_pr.ipynb",
    ...
    parser.add_argument(
        "--executed-notebook",
        default="executed_notebooks/CMIP_variable_exp5_baseline_physical_pr.executed.ipynb",
...
def main() -> int:
    ...
    print("[DONE] CMIP_variable_exp5_baseline_physical_pr batch run completed.")
    return 0
