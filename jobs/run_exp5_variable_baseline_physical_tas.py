#!/usr/bin/env python3
"""Run CMIP_variable_exp5_baseline_physical_tas notebook in batch mode and export artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Execute CMIP_variable_exp5_baseline_physical_tas notebook and export artifacts")
    parser.add_argument("--project-dir", default="/glade/u/home/tsalin/CMIP", help="Project directory containing notebooks/")
    parser.add_argument(
        "--notebook",
        default="notebooks/trainings/variable/CMIP_variable_exp5_baseline_physical_tas.ipynb",
    ...
    parser.add_argument(
        "--evaluation-dir",
        default="model_evaluation/Baseline_physical",
        help="Output folder (relative to project dir) for history and quality dataframes",
    )
    parser.add_argument(
        "--executed-notebook",
        default="executed_notebooks/CMIP_variable_exp5_baseline_physical_tas.executed.ipynb",
...
if "baseline_physical_quality_payload" not in globals():
    raise ValueError("baseline_physical_quality_payload is missing. Ensure the evaluation cell was executed.")
...
with open(_quality_path, "wb") as _qf:
    pickle.dump(baseline_physical_quality_payload, _qf)
...
def main() -> int:
    ...
    print("[INFO] Exported baseline-physical history and quality files successfully.")
    print("[DONE] CMIP_variable_exp5_baseline_physical_tas batch run completed.")
    return 0
